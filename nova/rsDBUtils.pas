...
type
  ...
  public
    ...
    procedure SetSQLConection(AComponent: TComponent; Conexao: TSQLConnection);
...
procedure TrsDBUtils.SetSQLConection(AComponent: TComponent; Conexao: TSQLConnection);
var
  I: Integer;
  oComp: TComponent;
begin
  ...
  begin
    oComp := AComponent.Components[I];
    if UpperCase(copy(oComp.Name,1,3)) = 'SDS' then
      TSQLDataSet(AComponent.Components[I]).SQLConnection := Conexao;
  end;
end;
